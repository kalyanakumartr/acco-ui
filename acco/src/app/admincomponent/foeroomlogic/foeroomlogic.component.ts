...
@Component({
  selector: 'app-foeroomlogic',
  templateUrl: './foeroomlogic.component.html',
  styleUrls: ['./foeroomlogic.component.scss']
})
export class FoeroomlogicComponent {
  roomData: any
  subscription: any;
  bookingData: any;
  optiontype: any;
 ...
 sendbookeddata(data: any) {
    ...
    this.router.navigate(["foebookingsummary",
